...
@alpa.parallelize(method=alpa.PipeshardParallel(layer_option=AutoLayerOption(layer_num=1),stage_option=UniformStageOption(num_stages=1),num_micro_batches=10),batch_argnums=(1,2))
...
@alpa.parallelize(method=alpa.PipeshardParallel(layer_option=AutoLayerOption(layer_num=1),stage_option=UniformStageOption(num_stages=1),num_micro_batches=10,pipeline_schedule="inference"),donate_argnums=(),batch_argnums=(1,2))
