...
@alpa.parallelize#(method=alpa.PipeshardParallel(layer_option=AutoLayerOption(layer_num=1),stage_option=UniformStageOption(num_stages=1)))
...
print("manual: ", manual_pipeline_actual_state.params)
print("excepted:", expected_state.params)
